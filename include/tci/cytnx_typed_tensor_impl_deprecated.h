...
#define TCI_DEPRECATED_ELEMT_API \
  ...
  template <typename ElemT, typename RandNumGen, std::enable_if_t<!detail::is_cytnx_tensor_v<ElemT>, int> = 0> [[deprecated(TCI_DEPRECATED_ELEMT_API)]]
  ...
  template <typename ElemT, typename RandomIt, typename Func, std::enable_if_t<!detail::is_cytnx_tensor_v<ElemT>, int> = 0>
  ...
  template <typename ElemT, typename Func, std::enable_if_t<!detail::is_cytnx_tensor_v<ElemT>, int> = 0> [[deprecated(TCI_DEPRECATED_ELEMT_API)]]
